...
FORM_FILES = [None, None, None, None] #[None, "data/input/CAPE.xlsx", "data/input/5D_Curiosity.xlsx", "data/input/NfCS_full.xlsx"] # e.g. ["CAPE.xlsx", None, "NfCS_full.xlsx"] or [None, None, None]
